...
class NotificationClient {
   public:
    NotificationClient(const std::string &server_ip, int server_port, const std::string &user_id,
                       std::queue<nlohmann::json> &notification_queue, std::mutex &queue_mutex,
