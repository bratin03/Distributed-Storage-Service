...
namespace kv
{
  ...
  {
  public:
    static void main(uint64_t id, const std::string &cluster, uint16_t port, const std::string &ip = "0.0.0.0", uint16_t redis_port = 6379, const std::string &redis_ip = "127.0.0.1");

    explicit RaftNode(uint64_t id, const std::string &cluster, uint16_t port, const std::string &ip = "0.0.0.0", uint16_t redis_port = 6379, const std::string &redis_ip = "127.0.0.1");
