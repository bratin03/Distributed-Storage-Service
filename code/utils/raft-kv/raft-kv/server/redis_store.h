...
namespace kv
{
  ...
  {
  public:
    explicit RedisStore(RaftNode *server, std::vector<uint8_t> snap, uint16_t port, const std::string &ip = "0.0.0.0", uint16_t redis_port = 6379, const std::string &redis_ip = "127.0.0.1");
